...
def _local_settings_mock(*, context_window: int = 16384) -> mock.Mock:
    settings = mock.Mock()
    settings.ask_apex.selected_model = "gemma-4-E2B-Q4_K_M.gguf"
    settings.ask_apex.local.last_model = "gemma-4-E2B-Q4_K_M.gguf"
...
class LocalModelLifecycleControlTests(unittest.TestCase):
    ...
    def test_load_rejects_demo_mode_without_touching_ollama(self) -> None:
        with mock.patch("core.api.cortex.DEMO_MODE", True), mock.patch(
            ...
            with self.assertRaises(HTTPException) as raised:
                load_local_model_endpoint("gemma-4-E2B-Q4_K_M.gguf")
    ...
    def test_local_model_status_reports_missing_selected_alias(self) -> None:
        snapshot = {
            "provider": "llama_cpp",
            "reachable": True,
    ...
    def test_local_model_status_reports_router_load_failure(self) -> None:
        ...
        self.assertEqual(local_status.loaded_model.state, "failed")
    ...
    def test_query_rejects_missing_local_alias_with_provider_label(self) -> None:
        ...
        with (
            ...
            with self.assertRaises(HTTPException) as raised:
                query_agent(AgentQueryRequest(prompt="hello", agent="apex"))
