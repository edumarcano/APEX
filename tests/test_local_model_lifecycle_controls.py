...
class LocalModelLifecycleControlTests(unittest.TestCase):
    def test_load_prewarms_only_after_gate_and_runtime_verification(self) -> None:
        with (
            ...
            mock.patch("core.api.cortex.is_local_model_resident", side_effect=[False, True]),
            ...
            mock.patch("core.api.cortex.get_status_snapshot") as snapshot,
        ):
    ...
    def test_load_never_reports_success_without_runtime_residency(self) -> None:
        with (
            ...
            mock.patch("core.api.cortex.is_local_model_resident", side_effect=[False, False]),
    ...
    def test_unload_claims_the_execution_slot_before_requesting_release(self) -> None:
        with (
            mock.patch("core.api.cortex.OLLAMA_MANUAL_UNLOAD_ENABLED", True),
            mock.patch("core.api.cortex.try_begin_local_execution", return_value=True),
            mock.patch("core.api.cortex.end_local_execution") as end_execution,
            mock.patch("core.api.cortex.get_status_snapshot", return_value={"reachable": True}),
    ...
    def test_profile_status_uses_ollama_residency_not_only_the_tracker(self) -> None:
        ...
        with (
            mock.patch("core.api.cortex.OLLAMA_ENABLED", True),
            mock.patch("core.api.cortex.get_status_snapshot", return_value=snapshot),
            mock.patch("core.api.cortex.get_active_loaded_model", return_value="qwen3:4b-instruct"),
            mock.patch("core.api.cortex.get_loading_model", return_value=None),
