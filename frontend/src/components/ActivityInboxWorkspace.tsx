  ...
  return (
    <section className="mx-auto flex min-h-0 w-full max-w-[1520px] flex-1 flex-col gap-4 px-4 pb-6 pt-2 sm:px-6" aria-label="External activity inbox">
      ...
      <div className="grid min-h-0 flex-1 gap-4 lg:grid-cols-[minmax(15rem,0.72fr)_minmax(0,1.5fr)]">
        <aside className="min-h-0 rounded-xl border border-white/10 bg-black/25 p-3 lg:overflow-y-auto scrollbar-inbox" aria-label="Activity reports">
        ...
        <article className="min-w-0 rounded-xl border border-white/10 bg-black/25 p-4 lg:overflow-y-auto scrollbar-inbox" aria-live="polite">
