...
describe('CortexWorkspace', () => {
  ...
  it('shows local controls from the selected model rather than a second Agent', () => {
    renderWorkspace({ selectedModel: localModel.model_id })
