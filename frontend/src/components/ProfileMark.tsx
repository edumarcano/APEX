...
const PROFILE_MARKS: Record<AssistantProfile, { icon: LucideIcon; label: string; className: string }> = {
  ...
  delphinus: { icon: Radio, label: 'Delphinus profile mark', className: 'border-teal-300/25 bg-teal-400/10 text-teal-200' },
  orcinus: { icon: BrainCircuit, label: 'Orcinus profile mark', className: 'border-indigo-300/25 bg-indigo-400/10 text-indigo-200' },
