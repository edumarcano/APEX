...
export function MarketTickerCard({ data, isLoading = false, enabled = true, className, isCompact = false, attentionTier = 'dormant', attentionStaggerMs = 0, chrome = 'card' }: MarketTickerCardProps): ReactElement {
