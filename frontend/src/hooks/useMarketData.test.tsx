...
const RESPONSE = {
  ...
  tickers: [{ symbol: 'SPY', status: 'healthy', freshness: 'live', reason_code: 'ok', observed_at: null, close_date: '2026-09-08', last_successful_fetch_date: '2026-09-09', last_attempt_date: '2026-09-09', next_attempt_date: null, price: 500, change: 1, change_percent: 0.2, history: [{ date: '2026-09-05', open: 499, high: 501, low: 498, close: 499, volume: 10 }, { date: '2026-09-08', open: 500, high: 502, low: 499, close: 500, volume: 12 }], period_return_percent: 0.2, period_low: 498, period_high: 502, volume_ratio: 1.2 }],
}
