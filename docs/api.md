...
Market participates in this lifecycle and in Sync Health. A Market refresh respects its separate 12-hour provider cache and may therefore return fresh cached daily data without a new Alpha Vantage request. Market remains excluded from briefing synthesis.
