...
| Interactive Agent conversation | Browser tab owns history | Selected cloud/local Agent and explicitly selected tools receive required context | No server-side chat store | Local Agent with No Tools or local runtime |
